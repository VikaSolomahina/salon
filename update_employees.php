...
$employees = mysqli_query($link,"SELECT * FROM `employees` WHERE `id` = '$employees_id'");
...
<div class="forma">
<body>
<h2 style="padding-top:7px;">Изменение данных о мастере</h2>
<form  action="./vendor/update_employees.php" method="post">
<input type="hidden" name="id" value="<?=$employees['id']?>">
<input type="text" name="fio" value="<?= $employees['fio'] ?>">
<br>
<br>
<select id="selectvalue" value="<?=$employees['role']?>" name="role" placeholder="Роль">
