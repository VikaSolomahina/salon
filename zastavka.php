...
<body>
    ...
    <div style="margin: 190px 0 0 280px; " class="form">
    <br>
    <h1 style="color:rgb(219, 217, 217); font-family: Monotype Corsiva;text-shadow:1px 1px #000,2px 2px #000;">Добро пожаловать!</h1>
    <?php 
